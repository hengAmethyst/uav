  ...
  <div id="gantaInfoManager">
    <Row class="formapRow">
      ...
      <i-col span="8">
        ...
        <div class="table">
          <div style="padding: 10px 0">人员列表</div>
          <Button type="primary" long>添加人员</Button>
          <Table border :columns="columns" :data="tableData"></Table>
        </div>
      </i-col>
    </Row>
    <Modal v-model="createTaskModel" fullscreen scrollable  ok-text="提交并保存" title="人员详情" >
      <div>
        <person-info-edit ref="child" v-on:closeModal="closeModal"></person-info-edit>
      </div>
    </Modal>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      generateColumns(){
        let col = []
            col.push({title: '人员',key: 'name',align: 'center'})
