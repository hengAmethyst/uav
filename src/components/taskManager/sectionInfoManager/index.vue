    ...
    <Row class="formapRow">
      ...
      <i-col span="8">
        ...
        <div class="table">
          ...
          <Button type="primary" long>创建区间</Button>
          <Table border :columns="columns" :data="tableData"></Table>
        </div>
      </i-col>
    </Row>
    <Modal v-model="createTaskModel" fullscreen scrollable  ok-text="提交并保存" title="区间详情" >
      <div>
        <section-info-edit></section-info-edit>
      </div>
    </Modal>
  </div>
</template>
<script>
  ...
  import sectionInfoEdit from './sectionInfoEdit'
